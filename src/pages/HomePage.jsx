...
function HomePage() {
  ...
  shadow-[0_2px_20px_rgba(0,0,0,0.6)] p-1 rounded">
      ...
      <Link to={"/exercises"}
            type="submit"
            className="inline-block w-auto m-2 px-5 bg-gradient-to-r from-indigo-800 to-teal-400 active:brightness-125 transition duration-300 text-white font-bold py-2 rounded mt-2"
          >
            Our Exercises
          </Link>
